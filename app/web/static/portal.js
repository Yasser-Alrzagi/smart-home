...
(() => {
  ...
  async function studentAttendance(epoch){const permissions=await api('/permissions/my');const reports=await api('/emergency/my');const absences=await api('/absences/my');
